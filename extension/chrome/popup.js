...
function getPersonas() {
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4) {
      // The check for "{" is a hack to detect when the personas request was redirected to the login page.
      // There does not seem to be a nice way to do this using XMLHttpRequest.
      if (this.status == 200 && this.responseText.startsWith("{")) {
