...
open class UnsignedMessage(type: String, key: MessageKey, val payload: ByteArray) : Message(type, key) {
    constructor(type: String, key: MessageKey, protoMessage: GeneratedMessageV3) : this(type, key, protoMessage.toByteArray())
    ...
    companion object : ProtoSerializable<UnsignedMessage, Proto.UnsignedMessage> {
        ...
        override fun fromProto(value: Proto.UnsignedMessage): UnsignedMessage {
            return UnsignedMessage(value.type, MessageKey.none, value.payload.toByteArray())
        }
