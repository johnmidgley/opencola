...
class CliTest {
    ...
    fun testExportImportRoundTrip(){
        ...
        val transactions0 = entityStore.getSignedTransactions(emptyList(), null, TransactionOrder.Ascending, 100)
        ...
        val transactions1 = entityStore.getSignedTransactions(emptyList(), null, TransactionOrder.Ascending, 100)
