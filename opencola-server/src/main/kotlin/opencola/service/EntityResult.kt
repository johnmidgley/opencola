...
data class EntityResult(val entityId: String, val dataId: String?, val summary: Summary, val activities: List<Activity>){
    constructor(entityId: Id, dataId: Id?, summary: Summary, activities: List<Activity>) : this(entityId.toString(), dataId?.toString(), summary, activities)
